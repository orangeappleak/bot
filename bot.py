...
async def on_message(msg):
    ...
    chat_filter=['fuck','fuck off','dick','esketit','bitch']
...
async def coinflip(ctx):
    ...
    if reply.content==final.content:
        ...
        await client.say('you lost it\ni am actually addicted towards winning you know')

@client.command(pass_context=True)
async def kiss(ctx,member:discord.Member):
    k=discord.Embed(description='hey {},{} gave you kiss'.format(member.mention,ctx.message.author.mention))
    kisses=['https://media.giphy.com/media/v4JbTGe4KJjKo/giphy.gif','https://cdn.discordapp.com/attachments/455323478267133962/459237164916670464/tenor.gif']
...
async def weather(ctx):
    await client.send_message('gathering the weather info,please wait')
    awa
